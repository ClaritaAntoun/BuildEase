...
$active_sql = "SELECT 
             ...
             WHERE wi.professionalID = ? AND wi.stepStatus = 'in_progress' AND wi.is_active = 1
...
<head>
    ...
    <title>Active Projects - BuildEase</title>
        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-12">
                    ...
                    <p class="text-center text-muted">Here are  the project you're currently working on</p>
